...
+=====================+================================================+============================================================================================================================================+
| Pre-workshop R prep | Code                                           |                                                                                                                                            |
+---------------------+------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
| Day 1: KFA          | \[Slides\] \[Code: Descriptive\] \[Code: kfa\] | |                                                                                                                                          |
+---------------------+------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
| Day 2, Part 1: MI   | [Slides](files/Week11.html){target="_blank"}\  | -   Review of MI and DIF: [Thissen, 2023](files/Thissen2023.pdf){target="_blank"}                                                          |
...
+---------------------+------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
| Day 2, Part 2: DIF  | [Slides](files/Week11.html){target="_blank"}\  | -   Factor analysis and IRT: [Wirth & Edwards, 2007](files/Wirth2007.pdf){target="_blank"}                                                 |
...
+---------------------+------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
| Day 3, Part 3: RDIF | [Slides](files/Week11.html){target="_blank"}\  | -   Robust scaling: [He & Cui, 2020](files/He2020.pdf){target="_blank"}                                                                    |
