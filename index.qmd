...
+=====================+=====================================================================+============================================================================================================================================+
| Pre-workshop R prep | [Code](files/Pre-workshop.html)                                     |                                                                                                                                            |
+---------------------+---------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
| Day 1: KFA          | [Slides](files/Day1_Slides.pdf){target="_blank"}\                   |                                                                                                                                            |
...
|                     | [Code](){target="_blank"}\                                          |                                                                                                                                            |
+---------------------+---------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+ 
| Day 3, Part 3: RDIF | [Slides]( ){target="_blank"}\                                       | -   Robust scaling: [He & Cui, 2020](files/He2020.pdf){target="_blank"}                                                                    |
|                     | [Notes]( ){target="_blank"}\                                        | -   Robust DIF: [Halpin, 2022](https://arxiv.org/abs/2207.04598){target="_blank"}; [Wang et al.,2022](files/Wang2022.pdf){target="_blank"} |
|                     | [Code]( ){target="_blank"}\                                         |                                                                                                                                            |
+---------------------+---------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
