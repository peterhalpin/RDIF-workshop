...
|-------------------|---------------------------|---------------------------|
| Day 1   | Slides - Notes - Coding Example | *Review of MI and DIF*: [Thissen, 2023](files/DIF-MIhistory9-12-23version.pdf)                                                                                                                                                                            |
| Day 2   | Slides - Notes - Coding Example | *Traditional approaches to DIF*: [Teresi et. al, 2021](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8889890/)                                                                                                                                             |
| Day 3   | Slides - Notes - Coding Example | *Robust scaling*: [He & Cui, 2020](files/He%20and%20Cui%20-%202020%20-%20Evaluating%20Robust%20Scale%20Transformation%20Methods%20Wit.pdf); Robust DIF: [Halpin, 2022](https://arxiv.org/abs/2207.04598); [Wang et al., 2022](files/Wang et al. - 2022 - Testing Differential Item Functioning Without Pred.pdf) |
